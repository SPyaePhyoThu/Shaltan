...
export const FirstPage = () => {
  return (
    <div className="pt-2 px-3 h-dvh  bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1518002171953-a080ee817e1f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
      <div className="w-full h-full bg-black bg-opacity-70 grid grid-rows-[min-content,0.8fr,min-content,0.2fr,.5fr]">
        <Navbar />
        ...
        <button className="bg-white text-black py-4 px-14 rounded-full font-semibold self-start justify-self-center text-lg">
