  ...
  return (
    <div className="w-card my-10 h-card rounded-xl bg-color5 flex justify-evenly">
      <div className="grid grid-row-[1fr max-content 1fr] justify-items-center ">
        ...
        <p className="text-black text-center text-sm px-0 pt-2 lg:px-4">
      ...
      <div className="w-1/2 lg:w-auto self-center">
        <Image
          src={adidas}
          alt="shoe"
          width={300}
...
export const Card2 = () => {
  return (
    <div className="w-card my-10 h-card rounded-xl bg-color2 flex justify-evenly">
      <div className="grid grid-row-[1fr max-content 1fr] justify-items-center ">
        <h3 className="font-heading text-black text-2xl md:text-3xl self-end">
          New Arrivals
        </h3>
        <p className="text-black text-center text-sm px-0 pt-2 lg:px-8">
  ...
  return (
    <div className="w-card my-10 h-card rounded-xl bg-color1 flex justify-evenly">
      <div className="grid grid-row-[1fr max-content 1fr] justify-items-center ">
        ...
        <p className="text-black text-center text-sm px-8 pt-2">
