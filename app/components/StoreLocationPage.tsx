...
export const StoreLocationPage = () => {
  return (
    <div className="h-full bg-color5 p-2 lg:p-5" id="store">
      <h1 className="font-heading text-center font-bold text-4xl m-1 xl:mb-10">
        Store Location
      </h1>
      <div className="grid grid-cols-[1fr,0.7fr] justify-items-center items-center">
        <Map />
        <div className="my-auto grid grid-rows-[min-content,max-content,0.5fr,min-content,min-content,0.1fr] ">
          ...
          <p className="indent-10 self-center  lg:leading-6 xl:leading-8 text-xs lg:text-sm xl:text-base ">
